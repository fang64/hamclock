...
extern bool installBMP (WiFiClient &client, const SBox &box, char ynot[], size_t ynot_len);
...
extern bool getClosestPSK (const LatLong &ll, DXSpot *sp);
